...
const NavBar = ({username}) => {
    ...
    return (
        <div className="navbar" style={{
            ...
            <div>
                <button style={{ background: 'green', color: 'black' }}>Browse Catalog</button>
                <button style={{ background: 'grey', marginLeft: '50px', color: 'black' }}>Community Portal</button>
            </div>
            <h1 style={{fontFamily:'Brush Script MT', color: 'black', fontSize: '50px',fontWeight: 'bold'}}>UPlant</h1>
            <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ color: 'black', fontSize: '20px', marginRight: '50px', border: '1px dotted white', padding: '0 10px' }}>
                    {username}
                </div>

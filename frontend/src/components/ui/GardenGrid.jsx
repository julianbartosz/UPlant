            ...
            {interactive && (
                <>
                    <div style={{ position: "absolute", top: "-20px", left: "50%", transform: "translateX(-50%)", zIndex: -0.5, display: "flex" }}>
                        {/* Top Center Button */}
                        <CircleButton text={<FaArrowUp />} className="grid-add-btn" onClick={() => handleGridResizing(1, "top", selectedGardenIndex)} />
                        <CircleButton text={<FaArrowDown />} className="grid-remove-btn" onClick={() => handleGridResizing(-1, "top", selectedGardenIndex)} />
                    </div>
                    <div style={{
                        position: "absolute",
                        top: "50%", left: "-20px",
                        ...
                        {/* Left Center Button */}
                        <CircleButton text={<FaArrowRight />} className="grid-remove-btn" onClick={() => handleGridResizing(-1, "left",selectedGardenIndex)} />
                        <CircleButton text={<FaArrowLeft />} className="grid-add-btn" onClick={() => handleGridResizing( 1, "left", selectedGardenIndex)} />
                    </div>
                    <div style={{
                        position: "absolute",
                        top: "50%", right: "-20px",
